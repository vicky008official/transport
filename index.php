...
<body id="body">
  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container clearfix">
      <div class="contact-info float-left">
        <i class="fa fa-envelope-o"></i> <a href="mailto:contact@example.com">matrixtravel@gmail.com</a>
        <i class="fa fa-phone"></i> +91 6385634232
      </div>
    </div>
  </section>
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#body" class="scrollto">Matrix<span>Travels</span></a></h1>
  ...
  <section id="intro">
    ...
    <h2>Unlock <span>your Journey</span><br><span style="font-size: 24px; color: black; text-decoration: none;">Where Every Destination Awaits!</span></h2>
